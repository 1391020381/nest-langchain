...
当前下一步：阅读序章与第一章，然后从**第二章**开始在本仓搭建工程底座。

## 章节索引

| 进度 | 章节 | 课本 | 官方对照分支（可选） |
| --- | --- | --- | --- |
| [ ] | 序章 | [1-序章](./AI%20Agents%20开发实践/1-序章：站在范式之变的十字路口.md) | — |
| [ ] | 第一章 | [2-第一章](./AI%20Agents%20开发实践/2-第一章：把模型变成能力.md) | — |
| [ ] | 第二章 | [3-第二章](./AI%20Agents%20开发实践/3-第二章：搭建智能体的工程底座.md) | [feat/foundation](https://github.com/Cookieboty/autix-demo/tree/feat/foundation) |
