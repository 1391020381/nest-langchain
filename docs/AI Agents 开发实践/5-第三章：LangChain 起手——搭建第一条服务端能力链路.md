...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8641f9e9a2ab4c8ead87df5315c607ff~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1216&h=770&s=587237&e=png&b=fefefe)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c7b19efa328c43e9b25ea202509d5281~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=1216&h=324&s=177196&e=png&b=fefefe)
...
用 `curl` 验证：
    ...
    curl -s -X POST http://localhost:3001/api/langchain/chain-invoke \
      -H "Content-Type: application/json" \
      -d '{"input": "用户注册时必须绑定手机号，密码至少8位"}'
...
![cleaned-image (4).png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/483e25eda6c44dcbb78764d9ed4262ca~tplv-k3u1fbpfcp-jj-mark:0:0:0:0:q75.image#?w=2528&h=1696&s=6899533&e=png&b=1f2733)
